...
export interface IWorkletContext {
     ...
     * ```
     */
    createRunAsync: <TArgs extends unknown[], TReturn>(worklet: (...args: TArgs) => TReturn) => (...args: TArgs) => Promise<TReturn>;
    /**
...
export interface IWorkletNativeApi {
     ...
     * ```
     */
    createRunOnJS: <TArgs extends unknown[], TReturn>(func: (...args: TArgs) => TReturn) => (...args: TArgs) => Promise<TReturn>;
    /**
